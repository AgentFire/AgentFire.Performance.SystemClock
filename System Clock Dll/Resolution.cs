...
namespace AgentFire.Performance.SystemClock
{
    ...
    public static class Resolution
    {
        ...
        static Resolution()
        {
            NtQueryTimerResolution(out int min, out int max, out _);
        ...
        public static TimeSpan Current
        {
            get
            {
                NtQueryTimerResolution(out int _, out _, out int current);
        ...
        public static bool TrySet(TimeSpan clockResolution)
        {
            ...
            NtSetTimerResolution((int)clockResolution.Ticks, true, out int result);
